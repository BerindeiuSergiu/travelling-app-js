    ...
    return (
        <div className="create-itinerary-wrapper" style={{overflowY: 'scroll', maxHeight: '70vh'}}>
            ...
            <div className="button-container">
                ...
                <button className="create-itinerary" >Create Itinerary</button>
                ...
                <div className="left-section">
                    ...
                    {(selectedCountry && selectedCity) && (
                        <div className="filters">
                            ...
                            <label>
                                Casual:
                                <input type="checkbox" checked={filters.casual}
                            ...
                            <label>
                                Food:
                                <input type="checkbox" checked={filters.food}
                            ...
                            <label>
                                Must:
                                <input type="checkbox" checked={filters.must}
                                       onChange={() => handleFilterChange('must')}/>
                            </label>
                            <label>
                                Nature:
                                <input type="checkbox" checked={filters.nature}
                                       onChange={() => handleFilterChange('nature')}/>
                            </label>
                            <label>
                                Night:
                                <input type="checkbox" checked={filters.night}
                                            ...
                                            <li key={activity.id}>
                                                ...
                                                {showDetails[activity.id] && (
                                                    <div className="activity-details">
                                                        <p>
                                                            <strong>Description:</strong> {showDetails[activity.id].description}
                                                        </p>
                                                        <p>
                                                            <strong>Location:</strong> {showDetails[activity.id].address || "Fetching address..."}
                                                        </p>
                                                        <p><strong>Estimated
                                                            Duration:</strong> {showDetails[activity.id].time} minutes
                                                        </p>
                                                        <p>
                                                        ...
                                                        <button className="button-test"
                                                                onClick={() => handleAddActivityToItinerary(activity.id, itineraryId)}>
                                                            Add to Itinerary
                                                        </button>
                                                    </div>
                                                )}
                                ...
                                {currentItineraryActivities
                                    ...
                                    .map(activity => (
                                        <li key={activity.id}>
                                            ...
                                            <button
                                                onClick={() => handleDeleteActivityFromItinerary(activity.id)}>Delete
                                            </button>
                                        </li>
                                    ))}
                            </ul>
